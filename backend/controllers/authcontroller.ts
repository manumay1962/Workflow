...
export const loginUser = async (req: Request, res: Response) => {
  ...
  try {
    ...
    return res.json({ success: true, token, user: { email: user.email, username: user.username || "User" } });
...
export const socialLoginUser = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const token = generateToken(user.id, user.email);
    return res.json({ success: true, token, isNewUser, user: { email: user.email, username: user.username || "User" } });
